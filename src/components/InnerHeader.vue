  ...
  <header>
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end">
        ...
        <li>
          <button v-if="isAdmin && isCategoria234" class="dropdown-item" @click="goToGarzon">
            Atención de clientes
          </button>
        </li>
        <li>
          <button v-if="isAdmin && isCategoria234" class="dropdown-item" @click="goToCaja">
            Gestión de caja
          </button>
        </li>
        ...
        <template v-if="isAdmin && !isCategoria1">
          ...
          <li>
            <button v-if="isCategoria34" class="dropdown-item" @click="goToZonas">Zonas</button>
          </li>
        ...
        <li>
          <button class="dropdown-item text-danger" @click="confirmLogout">Cerrar sesión</button>
        </li>
      </ul>
    </div>
  </header>
  ...
  >
    <div class="modal-content animate__animated animate__fadeInUp" @click.stop>
      ...
      <div class="modal-footer justify-content-center">
        <button class="btn btn-outline-primary rounded-pill" @click="showLogoutModal = false">
          Cancelar
        </button>
