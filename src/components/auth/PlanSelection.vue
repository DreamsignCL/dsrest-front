<template>
  <div class="form-container">
    ...
    <div class="form-container__body">
      <div class="accordion" id="accordionPlans">
        <div 
          ...
          <h2 class="accordion-header">
            <button 
              ...
              <p>
                <span class="fs-4 fw-bold text-primary">{{ plan.name }}</span><br>
                <small class="text-secondary">{{ plan.price }}</small>
              </p>
            </button>
          </h2>
          <div :id="`collapse${index}`" class="accordion-collapse collapse" :class="{ 'collapse': selectedPlan === index }" data-bs-parent="#accordionPlans">
            <div class="accordion-body">
              ...
              <div class="terms">
                <input type="checkbox" :id="'terms-' + index" v-model="acceptedTerms" @click.stop />
                <label :for="'terms-' + index">
                  Acepto los <button type="button" @click.stop="showTermsModal = true">términos y condiciones</button>
                </label>
              </div>
    ...
    <div class="form-container__footer">
      <button class="btn btn-outline-primary rounded-pill" @click="$emit('back')">
        Volver
      </button>
      <button 
    ...
    <div v-if="showTermsModal" class="modal animate__animated animate__fadeIn" @click.self="showTermsModal = false">
      <div class="modal-content animate__animated animate__fadeInUp">
        ...
        <div class="modal-footer">
          <button class="btn btn-secondary rounded-pill" @click="showTermsModal = false">Cerrar</button>
        </div>
      </div>
    </div>
  </div>
