        ...
        <div class="page-content__body">
          <div class="element-list">
            ...
            <button
              ...
              v-else
              :key="mesa.id"
              class="element-item element-item--table"
              @click="irAEditarMesa(mesa.id)"
            >
              <!--
              ...
              <div class="element-item__text">
                <span>#{{ mesa.numero }} {{ mesa.nombre }}</span
                ><br />
                <strong>Capacidad:</strong> {{ mesa.capacidad }} <strong>zona:</strong>
                {{ mesa.zona.id }}
              </div>
