...
const guardarPerfil = async () => {
  ...
  try {
    ...
    errorMessage.value = error.response?.data?.message || 'Error al actualizar el perfil. Verifique los datos e intente nuevamente.'
  }
}
            ...
            <form @submit.prevent="triggerSaveConfirmation">
              <div class="form-container form-container--no-header">
                ...
                <div class="form-container__footer">
                  <button type="button" @click="volver" class="btn btn-outline-primary rounded-pill">Volver</button>
