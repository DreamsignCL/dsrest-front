            ...
            <div class="page-content page-content--backoffice-order-details">
                ...
                <div class="page-content__body">
                    ...
                    <div class="details">
                        <div class="details__item">
                            <img src="../../assets/img/file-icon.svg" alt="Boleta" class="details__item__icon" />
                        ...
                        <div class="details__item">
                            <img src="../../assets/img/user-icon-blue.svg" alt="Garzon" class="details__item__icon" />
                            <div class="details__item__content">
                        ...
                        <div class="details__item">
                            <img src="../../assets/img/calendar-icon.svg" alt="Fecha" class="details__item__icon" />
                            <div class="details__item__content">
                    ...
                    <div class="element-list">
                        <div v-for="plato in platosDelPedido" :key="plato.menu_item_id" class="element-item element-item--added-dishes">
                            ...
                            <div class="element-item__price">
                                <span>Precio:</span><br>
                                <strong class="current-price">${{ (Number(plato.precioUnitario) || 0).toLocaleString() }}</strong>
                            </div>
                            <div class="element-item__text2">
                    ...
                    <div class="payment-info" v-if="pago">
                        <h3>Informacion de pago</h3>
                        <div class="payment-info__items">
                            <div class="payment-info__item">
                                <img src="../../assets/img/money-icon.svg" alt="Monto" class="details__item__icon" />
                            </div>
                            <div class="payment-info__item">
                            ...
                            <div class="payment-info__item" v-if="pago.vuelto != null">
                                <span>Vuelto:</span>
                    ...
                    <div class="alert alert--primary" v-if="pago?.propinaPagada > 0">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9.75 0C4.37402 0 0 4.37402 0 9.75C0 15.126 4.37402 19.5 9.75 19.5C15.126 19.5 19.5 15.126 19.5 9.75C19.5 4.37402 15.126 0 9.75 0ZM9.75 1.5C14.3145 1.5 18 5.18555 18 9.75C18 14.3145 14.3145 18 9.75 18C5.18555 18 1.5 14.3145 1.5 9.75C1.5 5.18555 5.18555 1.5 9.75 1.5ZM9 5.25V6.75H10.5V5.25H9ZM9 8.25V14.25H10.5V8.25H9Z" fill="currentColor"/>
                        </svg>
                        <span>Incluye propina<template v-if="pago.porcentajePropina"> del {{ pago.porcentajePropina }}%</template> ${{ Number(pago.propinaPagada).toLocaleString() }}</span>
                    </div>
                    </template>
                ...
                <div v-if="!isLoading && pedido" class="form-container">
                    <div class="form-container__footer">
                        <button class="btn btn-outline-primary rounded-pill w-100" @click="volver">Volver</button>
