  ...
  <div class="page page--backoffice">
    ...
    <main>
      <div class="page-content page-content--backoffice">
        ...
        <div
          v-if="!esAdmin"
          class="quick-status-tabs"
          role="tablist"
          aria-label="Filtros rápidos por estado"
        >
          <button
        ...
        <div class="page-content__body">
          ...
          <div v-if="esAdmin" class="financial-summary">
            <div class="financial-summary__item">
              <div class="financial-summary__icon">
                ...
                >
                  <path
                    d="M0 0V19.5H15V0H0ZM1.5 1.5H13.5V18H1.5V1.5ZM3 3V7.5H12V3H3ZM4.5 4.5H10.5V6H4.5V4.5ZM3.75 9V10.5H5.25V9H3.75ZM6.75 9V10.5H8.25V9H6.75ZM9.75 9V10.5H11.25V9H9.75ZM3.75 12V13.5H5.25V12H3.75ZM6.75 12V13.5H8.25V12H6.75ZM9.75 12V13.5H11.25V12H9.75ZM3.75 15V16.5H5.25V15H3.75ZM6.75 15V16.5H8.25V15H6.75ZM9.75 15V16.5H11.25V15H9.75Z"
                    fill="currentColor"
                  />
                </svg>
              </div>
            ...
            <div class="financial-summary__item">
              <div class="financial-summary__icon">
                ...
                >
                  <path
                    d="M17.2608 16H14.5701L18.67 0H21.9059L26 16H23.3092L20.3343 3.65625H20.2415L17.2608 16ZM17.0927 9.71094H23.4484V12.3516H17.0927V9.71094Z"
                    fill="currentColor"
                  />
                  <path
                    d="M6.72257 0L9.59309 12.1562H9.70327L12.5796 0H15.3631L11.269 16H8.03315L3.93323 0H6.72257Z"
                    fill="currentColor"
                  />
            ...
            <div class="financial-summary__item">
              <div class="financial-summary__icon">
                ...
                >
                  <path
                    d="M7.5 0V18H6V3H1.5V18H0V19.5H19.5V18H18V8.25H13.5V18H12V0H7.5ZM9 1.5H10.5V18H9V1.5Z"
                    fill="currentColor"
                  />
                  />
                </svg>
          ...
          <!-- Lista de atenciones -->
          <div v-if="atencionesFiltradas.length > 0" class="element-list">
            <div v-for="atencion in atencionesFiltradas" :key="atencion.id">
              <button
                :key="atencion.id"
              ...
              >
                ...
                <div class="element-item__options-menu">
                  <button
                    v-if="atencion.estado === 'pagado'"
                    class="btn btn-option"
                    @click="verAtencion(atencion)"
                  >
              ...
              <div v-if="detalleVisible === atencion.id" class="px-2 mt-3">
                ...
                <ul class="list-group">
                  ...
                  <div class="mt-3">
                    <SelectorPlatos
                      :platos-disponibles="platosDisponibles"
                      @plato-seleccionado="agregarPlatoAAtencion(atencion.id, $event)"
                    />
                  </div>
                  <li
                    v-for="(detalle, i) in detallesPedido[atencion.id]?.detalles"
                    :key="detalle.id"
                  ...
                  >
                    <div class="d-flex align-items-center justify-content-between w-100">
                      <div class="d-flex align-items-start gap-4 flex-wrap">
                        <div>
                          <div v-if="detalle.editando" class="d-flex align-items-center gap-2">
                            <input
                          ...
                          <div v-else>
                            <strong>x{{ detalle.quantity }}</strong>
                            <strong>{{ detalle.plato?.nombre }}</strong>
                          </div>
                        </div>
                        ...
                        <div class="d-flex flex-column">
                          <strong>Total</strong>
                          <span
                          >${{ (detalle.quantity * detalle.unit_price).toLocaleString() }}</span
                          >
                        </div>
                      </div>
                      ...
                      <div class="d-flex align-items-center gap-2">
                        ...
                        <button
                          ...
                          title="Eliminar"
                          @click="eliminarPlato(atencion.id, i)"
                        >
                          <img
        ...
        <!-- Modal de filtros -->
        <div
          v-if="showModalFiltros"
          class="modal animate__animated animate__fadeIn"
          @click.self="cerrarModalFiltros"
        >
          <div class="modal-content animate__animated animate__fadeInUp" @click.stop>
            ...
            <div class="mb-3">
              ...
              <select v-model="estadoSeleccionado" class="form-select form-select-sm">
            ...
            <div class="mb-3">
              ...
              <select id="zones" v-model="zonaSeleccionada" class="form-select form-select-sm">
...
const resumenFinanciero = computed(() => {
  ...
  const totalGeneral = atenciones.value
    .filter((p) => normalizarEstado(p.estado) === 'pagado')
    .reduce((acc, p) => acc + parseMonto(p.total), 0)

  const propina = totalGeneral * 0.1

  // 🔥 Si el total incluye IVA:
  const neto = totalGeneral / (1 + IVA_RATE)
  const iva = totalGeneral - neto

  return {
    neto,
    iva,
    propina,
    total: totalGeneral + propina,
  }
})
...
const manejarAccionEstado = async (atencion) => {
  ...
  if (transicion === undefined) {
    mostrarConfirmacion(
      'No se pudo consultar la transición del pedido. Intenta nuevamente en unos segundos.'
    )
    return
  }
...
const atencionesFiltradas = computed(() => {
  ...
  if (estadoSeleccionado.value) {
    lista = lista.filter((a) => a.estado?.toLowerCase() === estadoSeleccionado.value)
  }
  ...
  if (estadosSeleccionados.value.length > 0) {
    lista = lista.filter((a) => estadosSeleccionados.value.includes(a.estado?.toLowerCase()))
  }
