                    ...
                    <div class="form-container form-container" v-if="pasoActual === 1">
                        ...
                        <div class="form-container__footer">
                            ...
                            <button 
                                ...
                                type="button" 
                                @click="siguiente" :disabled="!ubicacionSeleccionada || !mesaSeleccionada">
                                Siguiente &gt;
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="form-container form-container" v-else-if="pasoActual === 2">
                        ...
                        <div class="form-container__footer footer-totals">
                            ...
                            <div class="buttons">
                                ...
                                <button class="btn btn-outline-secondary rounded-pill" @click="anterior">&lt; Atrás</button>
...
const guardarPedido = async () => {
    ...
    if (!ubicacionSeleccionada.value || !mesaSeleccionada.value || platosSeleccionados.value.length === 0) {
